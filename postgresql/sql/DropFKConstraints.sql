...
ALTER TABLE artist_image DROP CONSTRAINT IF EXISTS artist_image_fk_artist;
...
ALTER TABLE label_image DROP CONSTRAINT IF EXISTS label_image_fk_label;
...
ALTER TABLE master_image DROP CONSTRAINT IF EXISTS master_image_fk_master;
...
ALTER TABLE release_track_artist DROP CONSTRAINT IF EXISTS release_track_artist_fk_track;
...
ALTER TABLE release_image DROP CONSTRAINT IF EXISTS release_image_fk_release;
